...
config.TRAIN.n_epoch = 10 # 2000
config.TRAIN.lr_decay = 0.1
config.TRAIN.decay_every = int(config.TRAIN.n_epoch / 2)

## train set location
# config.TRAIN.hr_img_path = 'DIV2K/DIV2K_train_HR/'
config.TRAIN.hr_img_path = 'ISRO/Train_HR/'
# config.TRAIN.lr_img_path = 'DIV2K/DIV2K_train_LR_bicubic/X4/'
config.TRAIN.lr_img_path = 'ISRO/Train_LR/'


config.VALID = edict()
## test set location
config.VALID.hr_img_path = 'ISRO/ISRO_valid_HR/'
config.VALID.lr_img_path = 'ISRO/ISRO_valid_LR/'
